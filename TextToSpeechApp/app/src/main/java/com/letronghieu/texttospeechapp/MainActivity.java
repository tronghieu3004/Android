...
public class MainActivity extends AppCompatActivity {
    ...
    private Button mButtonSpeak,btnAddDoc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddDoc = findViewById(R.id.addDoc);
        ...
        btnAddDoc.setOnClickListener(view -> {
            Intent intent = new Intent(Intent.ACTION_OPEN_DOCUMENT);
            intent.addCategory(Intent.CATEGORY_OPENABLE);
            intent.setType("text/*"); // Chỉ chấp nhận các file văn bản
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == FILE_PICKER_REQUEST_CODE && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                // Xử lý URI của tệp văn bản được chọn
                readTextFromFile(fileUri);
                showToast("Document selected");
            }
        }
    }

    private void readTextFromFile(Uri fileUri) {
        try {
            ...
            // Hiển thị văn bản trong EditText
